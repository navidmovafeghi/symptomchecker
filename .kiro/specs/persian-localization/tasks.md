...
- [x] 1. Set up localization infrastructure
  ...
  - [x] 1.1 Create translation files structure
  ...
  - [x] 1.2 Create LocaleContext and provider
  ...
  - [x] 1.3 Write property test for locale persistence round-trip
...
- [x] 2. Implement RTL layout support





  - [x] 2.1 Add RTL CSS utilities and Tailwind configuration
  ...
  - [x] 2.2 Update layout.tsx for RTL support
  ...
  - [x] 2.3 Write property test for RTL direction consistency

    - **Property 3: RTL direction consistency**
    - **Validates: Requirements 2.1**

- [x] 3. Implement formatting utilities
  ...
  - [x] 3.1 Create date formatting utility
  ...
  - [x] 3.2 Create number formatting utilities
  ...
  - [x] 3.3 Write property test for Persian numeral conversion


    - **Property 4: Persian numeral conversion**
    - **Validates: Requirements 4.2**
  - [x] 3.4 Write property test for date formatting
...
- [x] 5. Create LanguageSwitcher component





  - [x] 5.1 Implement LanguageSwitcher UI component
  ...
  - [x] 5.2 Integrate LanguageSwitcher into Sidebar


    - Add LanguageSwitcher to Sidebar component
    - Position appropriately for both LTR and RTL layouts
    - _Requirements: 5.1_
  - [x] 5.3 Write property test for language change reactivity


    - **Property 7: Language change reactivity**
    - **Validates: Requirements 5.3, 5.4**

- [x] 6. Update UI components for localization



  - [x] 6.1 Update ChatPage component
  ...
  - [x] 6.3 Update MessageSkeleton and error displays


    - Localize loading messages and error text
    - Ensure RTL compatibility
    - _Requirements: 1.1_
  - [x] 6.4 Write property test for Persian text preservation
...
- [x] 8. Update backend for language support





  - [x] 8.1 Update DTOs to include language parameter
    ...
    - _Requirements: 3.4_
  - [x] 8.2 Update SymptomCheckerProvider for Persian responses
  ...
  - [x] 8.3 Write property test for system prompt language inclusion
...
- [x] 9. Update frontend API service
  ...
  - [x] 9.1 Update api.ts to pass language parameter
  ...
  - [x] 9.2 Update useChatViewModel to pass language

    - Pass current locale to API calls
    - Ensure language is included in all message requests
    - _Requirements: 3.4_

- [x] 10. Add Persian translations content





  - [x] 10.1 Complete Persian translation file
  ...
  - [x] 10.2 Add Persian font assets
